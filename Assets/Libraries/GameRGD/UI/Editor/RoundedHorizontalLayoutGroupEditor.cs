...
{
    [CustomEditor(typeof(RoundedHorizontalLayoutGroup), true)]
    [CanEditMultipleObjects]
    public class RoundedHorizontalLayoutGroupEditor : Editor
    {
        SerializedProperty m_VerticalGap;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_VerticalGap, true);
